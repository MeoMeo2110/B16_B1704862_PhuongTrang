package com.npt.phuongtrang.b16_b1704862_phuongtrang;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String URL = "http://10.0.2.2/dhminh/thongtin.php";
        String URL2 = "https://thuthuat.taimienphi.vn/huong-dan-cach-cai-dat-cau-hinh-va-su-dung-xampp-36056n.aspx";
        JSONObject postParams = new JSONObject();
        try
        {
            postParams.put("mscb", "000555");
        }
        catch (JSONException e)
        {
            e.printStackTrace();
        }
        PostComponent postRequest = new PostComponent(URL2, postParams);
    ...
    public InputStream OpenHttpConnection(PostComponent component) throws IOException
    {
        ...
        try
        {
            ...
            writer.close();
            os.close();
            /* (5) Lấy đáp ứng HTTP_OK để biết kết nối đã được thiết lập hay chưa */ response = httpConn.getResponseCode();
